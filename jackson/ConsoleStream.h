...
public:
	...
	typedef boost::signals2::signal<void(Buf*)> signalEmitString_t;
	typedef typename signalEmitString_t::slot_type slotEmitString_t;

  boost::signals2::connection ConnectEmitString(const slotEmitString_t& slot ) {
    return m_signalEmitString.connect( slot );
  }
...
private:
  ...
  signalEmitString_t m_signalEmitString;
