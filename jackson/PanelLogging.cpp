...
void PanelLogging::CreateControls() {
  ...
  //itemBoxSizer2->Add(m_txtLogging, 1, wxALL | wxEXPAND | wxALIGN_LEFT | wxALIGN_RIGHT | wxALIGN_TOP | wxALIGN_BOTTOM, 2);
  itemBoxSizer2->Add(m_txtLogging, 1, wxALL | wxEXPAND, 2);
  ...
  m_csb.ConnectEmitString( boost::phoenix::bind( &PanelLogging::HandleConsoleLine0, this, args::arg1 ) );
